...
-(void)cellLayout
{
    ...
    NSDictionary *viewsDictionary = @{@"nameView":self.topic, @"detailView":self.topicDescription, @"yesVote":self.up, @"noVote":self.down,  @"join":self.join, @"card":self.cardView, @"share":self.share, @"report":self.report };
